...
const TopicCard: FunctionComponent<TopicCardProps> = (props) => {
  return (
    <Card
      ...
      className='group flex flex-row flex-none snap-always snap-center justify-between shadow items-center p-2 md:p-4 transition duration-200 ease-in-out cursor-pointer bg-white/30 dark:bg-slate-800/30 rounded-2xl h-[70px] shadow-none border-none ring-1 ring-gray-200 dark:ring-slate-800 dark:hover:ring-slate-600 hover:ring-black my-2 mx-2'
    >
      <span className='text-[0.9rem] md:text-[1rem] font-mono tracking-normal text-gray-700 dark:text-gray-100 font-[500]'>
        {props.name}
      </span>
